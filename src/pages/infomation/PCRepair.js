            ...
            <div className="wrap">
                ...
                <div className={(openTab == 2 ? 'show' : 'service_as tab_content')}>
                    ...
                    <ServiceList01 className="mb80">
                        ...
                        <dl>
                            ...
                            <dd>
                                <p className="bullet02" data-num="1.">OS 재설치한 경우 15일 동안은 바이러스 및 기타 악성 프러그램, 파일 충돌도 15일(1회) 동안은 무상으로 서비스 해드립니다.</p>
                ...
                <div className={(openTab == 3 ? 'show' : 'service_price tab_content')}>
                    ...
                    <ul className="bullet01">
                        ...
                        <li><p>방문이 이루어지면 출장비는 반드시 청구되며, 취솔르 원하시면 반드시 방문 전 취소를 해 주셔야 합니다.</p></li>
