        ...
        <IntroduceLayout className="sub_section">
            ...
            <div className="wrap">
                ...
                <div className="inner">
                    ...
                    <p className="small">
                        이곳 MANGO COM 홈페이지에서는 서비스 신청뿐만 아니라 제품 정보, 서비스 이력을 직접 확인할 수 있도록 했으며 고객의 불편함을 원격을 통해 해결해 드리는 원격서비스를 비롯해 스스로 제품을 진단 할 수 있는 자가 진단 서비스 등 다양하고 유익한 정보를 드릴 수 있도록 구축하였습니다.
                    </p>
                    <p className="small">
